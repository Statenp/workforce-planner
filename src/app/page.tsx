...
export default function HomePage() {
  ...
  return (
    <div className="app">
      ...
      {planner.loading && (
        <p className="app-status app-status-loading" role="status">
      ...
      {planner.error && (
        <p className="app-status app-status-error" role="alert">
          {planner.error}
          {!planner.loading && ' — is the API running? Try `npm run dev:server`.'}
        </p>
      )}
      {planner.syncing && !planner.loading && (
        <p className="app-status app-status-syncing" role="status">
          Saving…
        </p>
      )}

      <div className={`layout ${planner.loading ? 'is-loading' : ''}`}>
        <FilterPanel
        ...
        <main className="main-panel">
          <div className="toolbar">
            <DateRangePicker
              ...
              activePreset={planner.activeDatePreset}
