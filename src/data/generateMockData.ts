...
import { getTodayString } from '../constants/forecastHorizon';
import type { DayRecord } from '../types';
import { DEPARTMENTS, METRICS, STORES } from './catalog';
...
export const DATA_ANCHOR_START = format(startOfMonth(new Date()), 'yyyy-MM-dd');
